...
def run_continual(root_path, csv_path):
    ...
    for tr, te in zip(train, test):
        train_domains.append(make_classification_dataset(tr))
        test_domains.append(make_classification_dataset(te))
    
    scenario = dataset_benchmark(
        train_datasets=train_domains,
        test_datasets=test_domains,
    )
